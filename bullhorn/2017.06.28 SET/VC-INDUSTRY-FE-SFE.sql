-- CANDIDATE
select id,external_id, first_name, last_name from candidate where external_id in ('110387-4971-1110')
 id in (124611) or first_name = 'Madeleine' or 
-- INDUSTRY
...
-- CANDIDATE FE SFE
select * from candidate_functional_expertise where candidate_id = 125374;
...
select * from functional_expertise where name = 'Corporate PR' --id in (3048,3113);
