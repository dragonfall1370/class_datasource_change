...
UNION ALL
        ...
        from bullhorn1.BH_CandidateHistory where comments is not null and cast(comments as varchar(max)) <> '' )

--select count(*) from comments where note <> '' --6346
select --top 100
                   candidateID
                  ...
                  , dateAdded
                  , note
from comments where note <> '' and candidateID in (1090,14449,16393,17669,1821,2140,22268,22606)