...
#find /mnt/vmware/temp/ -name *.rtf -type f > /tmp/DOCUMENT_CONTENT_FILE_2.txt
file=/tmp/DOCUMENT_CONTENT_FILE_2.txt
...
do
	...
	sed -i "/$doc_id/d" /tmp/DOCUMENT_CONTENT_FILE_2.txt
