...
company['address'] = company[['Company Address', 'Company Address 1','Company Address 2','Company Address District / Suburb','Company Address Town / City','Company Address Prefecture','Company ZIP (Postal) Code','Company Country']].apply(lambda x: ', '.join([e for e in x if e]), axis=1)
company['location_name'] = company['address']
# %%
# assign contacts's addresses to their companies
comaddr = company[['company_externalid', 'address','location_name','Company Address 1','Company Address 2','Company Address District / Suburb','Company Address Town / City','Company Address Prefecture','Company ZIP (Postal) Code','Company Country']].drop_duplicates()
...
# %% addr 2
tem = comaddr[['company_externalid', 'address', 'Company Address 2']].dropna().drop_duplicates()
...
# %% state
tem = comaddr[['company_externalid', 'address', 'Company Address Prefecture']].dropna().drop_duplicates()
tem['state'] = tem['Company Address Prefecture']
