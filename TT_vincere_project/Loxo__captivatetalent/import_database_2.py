...
csv_path = r'D:\Tony\project\vincere_project\Loxo__captivatetalent\Database\New folder\prod\New folder'
...
for index, row in temp_msg_metadata.iterrows():
   ...
   tem = pd.read_csv(row['file_fullpath'], encoding='utf-8', dtype='unicode',sep=';')
