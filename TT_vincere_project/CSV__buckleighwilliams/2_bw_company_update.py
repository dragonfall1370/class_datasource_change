...
comaddr = company[['company_externalid', 'address','Company Address 1','Company Address 2']].drop_duplicates()
...
# %% country
tem = comaddr[['company_externalid', 'address']].dropna().drop_duplicates()
tem['country_code'] = 'GB'
tem['country'] = 'United Kingdom'
