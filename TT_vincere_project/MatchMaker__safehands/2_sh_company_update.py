...
select
 CONCAT('',cl.cli_no) as company_externalid
        ...
        ,case
                ...
                when cl.cli_country='Greece' then	'GR'
                when cl.cli_country='Virgin Islands UK' then	'VG'
                when cl.cli_country='Anguilla' then	'AI'
                when cl.cli_country='Ukraine' then	'UA'
                when cl.cli_country='Abu Dhabi' then	'AE'
                when cl.cli_country='South Africa' then	'ZA'
                when cl.cli_country='Gabon' then	'GA'
                when cl.cli_country='Haiti' then	'HT'
                when cl.cli_country='Uganda' then	'UG'
                when cl.cli_country='Tuvalu' then	'TV'
                ELSE 'GB'
        end as country_code
