...
# %%
sql ="""select c.ContactId as candidate_externalid
...
candidate = pd.read_sql(sql, engine_mssql)
candidate['candidate_externalid'] = 'EUK'+candidate['candidate_externalid']
candidate = candidate.dropna()
assert False
api = 'eff8624ecd7d05d76684238ec82c2cae'
vincere_custom_migration.insert_candidate_text_field_values(candidate, 'candidate_externalid', 'DirectTel', api, connection)
