...
activity = pd.read_sql("select * from vincere_activity limit 100000 offset 200000", engine_sqlite) #3
...
vincere_activity.map_activities_to_entities(conn_str_ddb, 66636)
