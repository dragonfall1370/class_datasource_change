...
document_path = r'D:\Tony\File\YourVoice\CU1002560_FFDocs_22-Jan-2021'
...
cv = pd.read_sql("""
select OriginalDocumentName, 1 as primary_document from document where Description like '%CV%'
""", engine_sqlite)
...
vindoc = vindoc.merge(cv, left_on='uploaded_filename', right_on='OriginalDocumentName', how='left')
vindoc = vindoc.drop_duplicates()
vindoc['primary_document'] = vindoc['primary_document'].fillna(0)
