...
# %% data connection
conn_str_ddb_bkup = 'postgresql+psycopg2://{0}:{1}@{2}:{3}/{4}'.format('tony', 'Yz0t@d4Ta', '35.158.17.10', '25432', 'sixtyeightpeople.vincere.io')
...
candidate_location = pd.read_csv(r'C:\Users\tony\Desktop\latlong\68people\cand_latlong.csv')
company_location = pd.read_csv(r'C:\Users\tony\Desktop\latlong\68people\comp_latlong.csv')
assert False
candidate_location = candidate_location.loc[candidate_location['location_id'].notnull()]
candidate_location['id'] = candidate_location['location_id']
...
company_location['id'] = company_location['location_id']
