...
# %% extract data
file = pd.read_sql("""
select cv.Id, cdl.LinkedEntityId as entityid, cv.pathonclient as Name, cv.CreatedDate
from ContentVersion cv  
join contentdocumentlink cdl on cv.ContentDocumentId = cdl.ContentDocumentId
