...
tem1 = job.loc[job['owner'].str.contains('@')]
tem2 = job.loc[~job['owner'].str.contains('@')]
tem2['owner'] = tem2['owner'].apply(lambda x: x.lower().replace(' ',''))
tem2['owner'] = tem2['owner']+'@email.com'
job = pd.concat([tem1, tem2])
...
tem1 = candidate.loc[candidate['owner'].str.contains('@')]
tem2 = candidate.loc[~candidate['owner'].str.contains('@')]
tem2['owner'] = tem2['owner'].apply(lambda x: x.lower().replace(' ',''))
tem2['owner'] = tem2['owner']+'@email.com'
candidate = pd.concat([tem1, tem2])
# assert False
# %% transpose
