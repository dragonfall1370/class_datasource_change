...
assert False
# %% company
company = pd.read_csv(r'D:\Tony\project\vincere_project\CSV__lavandi\Data\company.csv')
...
contact = pd.read_csv(r'D:\Tony\project\vincere_project\CSV__lavandi\Data\contact.csv')
contact = contact.fillna('')
contact = contact.merge(company, on=['Company Name', 'Company Address', 'Company Address 1', 'Company Address 2', 'Company Address District / Suburb', 'Company Address Town / City', 'Company Address Prefecture', 'Company ZIP (Postal) Code','Company Country','Company Phone', 'Company Fax', 'Company Website', 'Company Brief / Summary'], how='left')
