...
document_path_1 = r'D:\Tony\File\Aug_TheoJamesRecruitmentLimited_12098_BULLHORN11235\UserAttachments'
document_path_2 = r'D:\Tony\File\Aug_TheoJamesRecruitmentLimited_12098_BULLHORN11235\UserWorkFiles'
...
assert False
################################################
temp_msg_metadata1 = vincere_common.get_folder_structure(document_path_1)
temp_msg_metadata2 = vincere_common.get_folder_structure(document_path_2)
temp_msg_metadata1['matcher'] = temp_msg_metadata1['root'].apply(lambda x: x.split('UserAttachments')[1])
temp_msg_metadata2['matcher'] = temp_msg_metadata2['root'].apply(lambda x: x.split('UserWorkFiles')[1])
temp_msg_metadata = pd.concat([temp_msg_metadata1, temp_msg_metadata2])
...
temp_msg_metadata['matcher'] = temp_msg_metadata.matcher.str.lower()

temp_msg_metadata.loc[temp_msg_metadata.file == '26155.docx']
temp_msg_metadata.loc[temp_msg_metadata.file == '24772.docx']
temp_msg_metadata.loc[temp_msg_metadata.matcher.str.contains('clientcorporationfiles')]


# %% company
company_file['directory'] = company_file['directory'].apply(lambda x: x.replace('/','\\') if x else x)
company_file['matcher'] = '\\' + company_file.directory.str.lower() + company_file.UploadedName.str.lower()
...
# %% contact
contact_file['directory'] = contact_file['directory'].apply(lambda x: x.replace('/','\\') if x else x)
contact_file['matcher'] = '\\' + contact_file.directory.str.lower() + contact_file.UploadedName.str.lower()
...
# %% job
job_file['directory'] = job_file['directory'].apply(lambda x: x.replace('/','\\') if x else x)
job_file['matcher'] = '\\' + job_file.directory.str.lower() + job_file.UploadedName.str.lower()
...
# %% candidate
candidate_file['directory'] = candidate_file['directory'].apply(lambda x: x.replace('/','\\') if x else x)
candidate_file['matcher'] = '\\' + candidate_file.directory.str.lower() + candidate_file.UploadedName.str.lower()
...
# candidate_file['count'] = candidate_file.groupby(['UploadedName']).cumcount()
