...
, nullif(lower(trim(Email)),'') as email, nullif(trim(Mobile),'') as Mobile, nullif(trim(Phone),'') as Phone, nullif(trim(Liaison_Type),'') as Job_Title, Contact_Salutation
