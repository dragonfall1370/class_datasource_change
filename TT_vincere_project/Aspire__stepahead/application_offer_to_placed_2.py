...
# %% connect db
ddbconn = psycopg2.connect(host='18.141.9.123', user='tony', password='Yz0t@d4Ta', database='tony.vincere.io', port=55432)
ddbconn.set_client_encoding('UTF8')
assert False
# load placement
placements = pd.read_csv(os.path.join(standard_file_upload, 'C:\\Users\\tony\\Desktop\\New folder (2)\\7_jobapplication_placement.csv'))
