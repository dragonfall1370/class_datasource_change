...
select * from jobapp where application_stage is null
""", engine_mssql)
jobapp['application_stage'] = 'Interested'
jobapp.loc[(jobapp['Rejected'] == True), 'application_stage'] = 'Rejected'
assert False
# %% mapping stage
...
df_jobapplication_other.to_csv(os.path.join(standard_file_upload, '7_jobapplication_other_2.csv'), index=False)