...
# %% extract data
# file1 = pd.read_sql("""
# select APP_ID, COMPANY_ID, CONTACT_ID, JOB_ID, DOC_PATH from Documents;
# """, engine_mssql)
# file2 = pd.read_sql("""
# select ApplicantId as APP_ID, DocumentPath as DOC_PATH from Document;
# """, engine_mssql)
# file = pd.concat([file1, file2])
# # file = file.dropna()
# file['DOC_PATH'] = file['DOC_PATH'].apply(lambda x: x[3:])
#
