...
from Placement_new p
LEFT JOIN User_new u1 ON p.ts2__Filled_By__c = u1.Id
LEFT JOIN User_new u2 ON p.ts2__Filled_By_2__c = u2.Id
""", engine_sqlite)
placement_detail_info = placement_detail_info.drop_duplicates()
