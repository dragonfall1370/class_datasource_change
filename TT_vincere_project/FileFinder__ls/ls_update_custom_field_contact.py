...
api = '7ef65742e491c9553e5a3a3ec387a22d'
cand = tem3[['candidate_externalid', 'Vincere Value']]
cand = cand.drop_duplicates()
vincere_custom_migration.insert_contact_muti_selection_checkbox(cand, 'candidate_externalid', 'Vincere Value', api, connection)
...
api = '78e710b0a10870fc4a7a058bc2834257'
cand = cand.drop_duplicates()
cand['Value'] = cand['Value'].str.strip()
vincere_custom_migration.insert_contact_muti_selection_checkbox(cand, 'candidate_externalid', 'Value', api, connection)
...
cand_international_api = '0fee88d846191c14453f8ff62e9b4920'
cand = tem3[['candidate_externalid', 'Vincere Value']]
cand = cand.drop_duplicates()
cand = cand.where(cand.notnull(), None)
vincere_custom_migration.insert_contact_muti_selection_checkbox(cand, 'candidate_externalid', 'Vincere Value', cand_international_api, connection)
