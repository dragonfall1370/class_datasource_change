...
left join ts2__Source__c s on c.ts2__Candidate_Source__c = s.Id
where c.IsDeleted = 0
""", engine_sqlite)
assert False
...
vcand.update_candidate_current_employer_title_v2(a, dest_db, mylog)
...
# %% update state
cp4 = vcand.update_location_state(comaddr, dest_db, mylog)
# update postcode
