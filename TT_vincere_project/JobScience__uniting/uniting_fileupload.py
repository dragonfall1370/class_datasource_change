...
document_path = r'D:\Uniting File'
...
vindoc = vindoc[['id', 'uploaded_filename']].merge(temp_msg_metadata[['alter_file2', 'Name']], left_on='uploaded_filename', right_on='alter_file2', how='left')
