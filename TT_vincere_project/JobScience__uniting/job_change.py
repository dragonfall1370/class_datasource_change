...
job['position-externalId'].value_counts()
job_prod_match.loc[~job_prod_match['external_id'].isin(job['position-externalId'])]
...
job_prod_match = job_prod_match.drop_duplicates()
