...
# %% connect db
job = pd.read_csv('j_add.csv')
job['ts2__Job__c'].unique()
#
# df = []
# def get_data(id):
#     url = "https://unitingambition.my.salesforce.com/services/data/v47.0/sobjects/ts2__Job__c/"+id
#
#     headers = {
...
#     print(row['ts2__Job__c'])
#     print(index)
#     get_data(row['ts2__Job__c'])
#
# job_add = pd.concat(df)
# job_add['ts2__Account__c']
# job_add.to_csv('Job_new.csv')
