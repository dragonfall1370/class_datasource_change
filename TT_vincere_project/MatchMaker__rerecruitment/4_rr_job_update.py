...
tem.loc[(tem['serv_description'] == 'ADHOC'), 'job_type'] = 'permanent'
tem.loc[(tem['serv_description'] == 'DAY BOOKING'), 'job_type'] = 'contract'
tem.loc[(tem['serv_description'] == 'REGISTER'), 'job_type'] = 'permanent'
tem.loc[(tem['serv_description'] == 'ES'), 'job_type'] = 'permanent'
