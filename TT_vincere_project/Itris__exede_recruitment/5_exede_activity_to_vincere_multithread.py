...
vincere_activity.map_activities_to_entities(conn_str_ddb, current_activity_id.loc[0].current_activity_id)

sdbconn_engine = sqlalchemy.create_engine(conn_str_ddb, pool_size=200, max_overflow=300, client_encoding='utf8', use_batch_mode=True)
connection = sdbconn_engine.raw_connection()
vincere_custom_migration.execute_sql_update("delete from activity where insert_timestamp is null", connection)
