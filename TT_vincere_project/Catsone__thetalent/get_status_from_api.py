...
df = []
def get_data(index):
    url = "https://api.catsone.com/v3/pipelines/workflows/5554787/statuses"
    ...
    json = response.json()
    print(json)
    df.append(json_normalize(json['_embedded']['statuses']))
    print('done: '+str(i))
...
df_to_csv.to_csv('statuses.csv', index=False)