...
DROP TABLE IF EXISTS truong_intjob;
CREATE TABLE IF NOT EXISTS truong_intjob as
              select a.posid,
                                  group_concat(
...
select * from truong_intjob;
select count(*) from truong_intjob;



-------------  JOB PUBLIC DESCRIPTION
DROP TABLE IF EXISTS truong_pubjob;
CREATE TABLE IF NOT EXISTS truong_pubjob as
              select posid
                     ,group_concat(
              ...
              #where a.posid = 2553
              group by posid;
select * from truong_pubjob;
select count(*) from truong_pubjob;



------    NOTE
DROP TABLE IF EXISTS truong_notejob;
CREATE TABLE IF NOT EXISTS truong_notejob as
                            select a.posid,
                     group_concat(
...
select * from truong_notejob;
select count(*) from truong_notejob;