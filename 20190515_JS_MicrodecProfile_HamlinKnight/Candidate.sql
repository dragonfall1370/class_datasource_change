...
,statuscode as (select * from lookup where code_type = 105)

,statusreasoncode as (select * from lookup where code_type = 265)
...
iif(b.date_of_birth is null or b.date_of_birth = '',null,convert(datetime, CONVERT(float,b.date_of_birth))) as 'candidate-dob',
...
concat('External ID: ',b.person_ref,(char(13)+char(10)),
...
nullif(concat('Driver: ',iif(b.driver is null or b.driver = '','','Yes'),(char(13)+char(10))),concat('Driver: ',(char(13)+char(10)))),
nullif(concat('Own Car: ',iif(b.own_car is null or b.own_car = '','','Yes'),(char(13)+char(10))),concat('Own Car: ',(char(13)+char(10)))),
...
nullif(concat('Do Not Mailshot: ',iif(a.part_time is null or a.part_time = '','',iif(a.part_time = 'Y','Yes','No')),(char(13)+char(10))),concat('Do Not Mailshot: ',(char(13)+char(10)))),
nullif(concat('Status: ',g.description,(char(13)+char(10))),concat('Status: ',(char(13)+char(10)))),
nullif(concat('Status Reason: ',h.description,(char(13)+char(10))),concat('Status Reason: ',(char(13)+char(10)))),

nullif(concat('Seeking: ',a.seeking,(char(13)+char(10))),concat('Seeking: ',(char(13)+char(10)))),
nullif(concat('Income Required: ',a.income_required,(char(13)+char(10))),concat('Income Required: ',(char(13)+char(10)))),
nullif(concat('Income Mode: ',a.income_mode,(char(13)+char(10))),concat('Income Mode: ',(char(13)+char(10)))),
nullif(concat('Package Required: ',a.package_required,(char(13)+char(10))),concat('Package Required: ',(char(13)+char(10)))),
...
nullif(concat('Full Time: ',iif(a.full_time is null or a.full_time = '','','Yes'),(char(13)+char(10))),concat('Full time: ',(char(13)+char(10)))),
nullif(concat('Part_time: ',iif(a.part_time is null or a.part_time = '','','Yes'),(char(13)+char(10))),concat('Part_time: ',(char(13)+char(10)))),
nullif(concat('Note: ',d.notes,(char(13)+char(10))),concat('Note: ',(char(13)+char(10))))
...
left join address c on b.person_ref = c.person_ref
...
left join statuscode g on d.status = g.code
left join statusreasoncode h on d.status_reason = h.code
)
