...
application AS (
	...
	WHERE real_stage IN ('Client Invoiced', 'Invoice paid', 'Started new position', 'Invoice', 'Shift booking')
...
SELECT
	...
	CASE
		...
		WHEN job_type IN ('Temporary vacancy', 'Shift requirement') THEN 2
	END position_type,
	CASE
		WHEN job_type = 'Permanent vacancy' THEN 301
		WHEN job_type IN ('Temporary vacancy', 'Shift requirement') THEN 303
