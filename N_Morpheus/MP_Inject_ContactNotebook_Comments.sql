 select concat('MP',cc.ClientContactId) as ContactExternalId, -10 as userId, ng.CreatedOn as CommentTimestamp
...
where ClientContactId is not NULL-- and  NotebookTypeId in (75,84,53)
