...
CONCAT_WS(
	E'\n',
	CASE WHEN cde.driver IS NOT NULL THEN CASE WHEN cde.driver = 'Y' THEN 'Driver: Yes' ELSE 'Driver: No' END END,
	CASE WHEN cde.own_car IS NOT NULL THEN CASE WHEN cde.own_car = 'Y' THEN 'Own car: Yes' ELSE 'Own car: No' END END,
...
-- AND cde.responsible_user IN ('88610', '233571', '295404', '304691')
-- AND co.email_address = 'tammie.huntley@hamlinknight.co.uk'