...
iif(b.description <> '',dbo.udf_StripHTML(replace(b.Description,'Subject:',concat((char(13)+char(10)),'Subject:',(char(13)+char(10))))),'')) as 'Description' ,
...
where Recordtype.Name = 'Candidate' and WhoId is not null
Go
----------------------------
