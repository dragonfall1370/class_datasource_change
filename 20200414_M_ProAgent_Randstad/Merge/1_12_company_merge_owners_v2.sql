...
, owners_group as (select vc_company_id, string_agg(distinct company_owners, ',') as owners_group 
	from distinct_owners
	group by vc_company_id) --select * from owners_group where vc_company_id = 16592
