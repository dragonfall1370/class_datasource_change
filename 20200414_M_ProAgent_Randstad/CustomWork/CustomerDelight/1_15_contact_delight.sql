...
, job_contact as (select pd.id
	...
	) --select * from job_contact where office_in_charge is not NULL and contact_id = 26659
...
and jc.contact_id in (select distinct contact_id from placed_condition) --15-filter conditions
