...
select 
	...
	, ja.max_booked_date as "Placement dates"
	, ja.max_offer_date as "Offer dates"
	, ja.max_interview1_date as "1st interview dates"
	, ja.max_interview2_date as "2nd+ interview dates"
	, cs.name as "Source"
	, ua.name as "Sourcer"
	, ca.candidate_comment as "Last activity comment"
	, coalesce(ce.last_activity_date, ca.insert_timestamp) as "Last activity date"
