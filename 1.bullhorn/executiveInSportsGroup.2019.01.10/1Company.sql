...
note as (
	...
	, Stuff( Coalesce('ID: ' + NULLIF(cast(CC.clientCorporationID as varchar(max)), '') + char(10), '')
              ...
              --+ Coalesce('Address (Custom): ' + NULLIF(cast(cc.customtextblock3 as varchar(max)), '') + char(10), '')
