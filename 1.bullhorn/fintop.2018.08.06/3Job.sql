...
, note as (
	...
	, Stuff(  Coalesce('Job ID: ' + NULLIF(cast(JP.jobPostingID as varchar(max)), '') + char(10), '')
...
/*       , Stuff( Coalesce('Location Requirements: ' + NULLIF(cast(a.onSite as varchar(max)), '') + char(10), '')
	...
	, businessSectorID as 'INDUSTRY'
       , categoryID as 'FUNCTIONAL EXPERTISE'
       , skillID as 'SUB FUNCTIONAL EXPERTISE'
       , source as 'CANDIDATE SOURCES'
