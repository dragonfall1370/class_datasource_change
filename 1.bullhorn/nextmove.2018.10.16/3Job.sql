...
select --top 100
	...
	, convert(varchar(10),getdate()-1,120) as 'position-endDate' --, convert(varchar(10),iif(a.isOpen in (null,0),getdate()-1,dateClosed),120) as 'position-endDate'
	...
	, skills as 'skills'
-- select distinct employmentType -- select distinct Type -- select distinct status -- select distinct customtext1 -- select count(*) --2323 -- select top 100 startDate  -- 
