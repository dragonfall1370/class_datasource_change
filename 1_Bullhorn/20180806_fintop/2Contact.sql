--ALTER DATABASE [fintop2] SET COMPATIBILITY_LEVEL = 130;
with
...
, note as (
	select UC.userID
	, Stuff(  Coalesce('Contact ID: ' + NULLIF(cast(UC.userID as varchar(max)), '') + char(10), '')
...
--       , UC.countryID --<<
	...
	, UC.NickName -->> 'PreferredName'
       ...
       , UC.customText1 as 'contact-LinkedIn'
       --, cl.businessSectorID as 'INDUSTRY'
       --, cl.categoryID as 'FUNCTIONAL EXPERTISE'
