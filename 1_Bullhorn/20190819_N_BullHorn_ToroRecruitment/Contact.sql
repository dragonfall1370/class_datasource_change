...
--        select  userID, trim(value) as ownerId
--        from bullhorn1.BH_UserContact cross apply string_split(cast(ownerUserIDList as nvarchar(max)), ',')
        select  cl.userID, trim(value) as ownerId
        from bullhorn1.Client cl
        left join bullhorn1.BH_UserContact UC cross apply string_split(cast(ownerUserIDList as nvarchar(max)), ',') on Cl.userID = UC.userID
        where (Cl.isdeleted <> 1 and Cl.status <> 'Archive')  
        and uc.ownerUserIDList is not null       
        UNION    
        select  userID, recruiterUserID from bullhorn1.BH_Client
) , ownersfinal as (
        select o.userID,
        ...
        group by o.userID
) , EducationSummary (userId, es) as ( ----EDUCATION
       SELECT userId
       , STRING_AGG(cast(
	...
	, concat_ws(char(10)
                ...
                , coalesce('Number of Temps: ' + NULLIF(cast(UC.customText1 as varchar(max)), ''), NULL)
                , coalesce('Number of Perms: ' + NULLIF(cast(UC.customText2 as varchar(max)), ''), NULL)
--                , coalesce('Fax: ' + NULLIF(cast(UC.fax as varchar(max)), ''), NULL)
                , coalesce('Title: ' + NULLIF(cast(UC.namePrefix as varchar(max)), ''), NULL)
                , coalesce('Consultant: ' + NULLIF(cast(UC2.name as varchar(max)), ''), NULL)
...
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText3 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText4 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText5 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText6 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText7 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText8 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText9 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText10 as varchar(max)), ''), NULL)
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText11 as varchar(max)), ''), NULL)
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText12 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText13 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText14 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText15 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText16 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText17 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText18 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText19 as varchar(max)), ''), NULL) 
--               , coalesce('Lead Status: ' + NULLIF(cast(UC.customText20 as varchar(max)), ''), NULL)                   		
...
--        left join bullhorn1.BH_UserEducation ue on ue.userID=UC.userID
...
-----MAIN SCRIPT------
select 
         concat('TRCT',Cl.clientID) as 'contact-externalId'
       , iif(UC.clientCorporationID in (select clientCorporationID from bullhorn1.BH_ClientCorporation where status <> 'Archive')
       , concat('TRCP', UC.clientCorporationID), 'TRCP999999999' ) as 'contact-companyId' 
...
--       , uc.nickName as 'Preferred-Name'      --CUSTOM SCRIPT #
...
--and Cl.userID =8861
UNION
select 'TRCT999999999','TRCP999999999','Default','','Contact','','','','','','','This is default contact from data migration'