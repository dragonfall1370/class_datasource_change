...
--, c.Country as 'candidate-country'
       ...
       , c.ExpectedSalary as 'candidate-desiredsalary'
       , c.CurrentSalary as 'candidate-currentsalary'
       ...
       , ltrim(Stuff(    
                        ...
                        + Coalesce('Candidate Source: ' + NULLIF(c.Source, '') + char(10), '')
...
-- select * -- select distinct ResidentialLocation
from Candidates c 
