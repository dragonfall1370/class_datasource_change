--DROP FUNCTION IF EXISTS "bullhorn1"."fn_ConvertHTMLToText"
--GO
ALTER FUNCTION "bullhorn1"."fn_ConvertHTMLToText"(@Text NVARCHAR(MAX))
--ALTER FUNCTION "bullhorn1"."fn_ConvertHTMLToText"(@Text NVARCHAR(MAX))
...
BEGIN
 ...
 SET @Text = REPLACE(REPLACE(REPLACE(REPLACE(
		@Text
