...
with abc as (
	select [application-candidateExternalId], [application-positionExternalId], [application-stage], aso.[Order] as StageOrder, apps.RejectedDate from (
		select
		...
		, ja.LastModifiedDate as RejectedDate
