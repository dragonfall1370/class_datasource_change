...
--select * from tmp_5
, tmp_6 as (select userID, concat(Status1,char(10),Department,char(10),DesignedCategories,char(10),DesiredSpecialties,char(10),DesiredSkills) 
...
select UC.clientCorporationID as 'contact-companyId'
	...
	, concat(f.CombinedNote, d.Notes) as 'contact-comments'
...
-----------------
select CL.clientCorporationID, CL.clientID, CL.userID, CL.recruiterUserID, UC.email, UC.name from bullhorn1.BH_Client CL
