...
select * from bullhorn1.BH_JobPosting where jobPostingID = 1008

select * from bullhorn1.BH_Usercontact where userID = 249

select UC.name, * from bullhorn1.BH_Client CL
left join bullhorn1.BH_Usercontact UC on CL.userID = UC.userID
where CL.userID = 19295