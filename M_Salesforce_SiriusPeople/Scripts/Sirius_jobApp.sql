...
, case when STATUS_CANDIDATE_PROGRESS__C = 'Internal / Skype Interview' then '1'
	...
	--when STATUS_CANDIDATE_PROGRESS__C = 'New' then '1' --remove when in PROD
	--when STATUS_CANDIDATE_PROGRESS__C = 'Database' then '1' --remove when in PROD
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Unsuitable' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Unsuitable - Culture Fit' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Unsuitable - No Work Rights' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Unsuitable - Location' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Unsuitable - Experience' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Candidate Not Interested - Found Other Employment' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Unsuitable - Consider for Other Roles' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Candidate Not Interested' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Candidate Not Interested - Location' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Candidate Not Interested - Salary' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Telephone Screen - Candidate Withdrew from Process' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'Possible / Follow Up - Unsuitable - Salary Too Low' then '1'
	when STATUS_CANDIDATE_PROGRESS__C = 'CV Sent - Candidate Withdrew from Process' then '1'
