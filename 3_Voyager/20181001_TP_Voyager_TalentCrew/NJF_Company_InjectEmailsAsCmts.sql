...
select concat('NJF',ca.intCompanyId) as CompanyExternalId, -10 as userId
		...
		, concat('-----MIGRATED FROM EMAILS-----',
				...
				iif(ca.dtInserted = '' or ca.dtInserted is null, '', concat(char(10),'Inserted Date: ',ca.dtInserted)),
