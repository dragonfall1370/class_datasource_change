...
select concat('NJFS', c.intCandidateId) as 'candidate-externalId', p.intPersonId  as PersonId--just for reference afterward
...
, iif(cme.CandidateEmail = '' or cme.CandidateEmail is NULL,concat('NJFS_ID',c.intCandidateId,'@noemail.com'),cme.CandidateEmail) as 'candidate-email'
...
, left(
	concat('Candidate External ID (NJF Search): NJFS',c.intCandidateId
