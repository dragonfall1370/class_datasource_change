...
select 
iif(tc.intCompanyId = '' or tc.intCompanyId is NULL,'NJFC9999999',concat('NJFC',tc.intCompanyId)) as 'contact-companyId'
, tc.intCompanyId as '(OriginalCompanyID)'
, com.vchCompanyName as '(OriginalCompanyName)'
, concat('NJFC',tc.intCompanyTierContactId) as 'contact-externalId'
...
, left(
	concat('Contact External ID: NJFC',tc.intCompanyTierContactId,char(10)
...
UNION ALL
select 'NJFC9999999','','','NJFC9999999','NJF Contract - Default','Contact','','','','','','','','','This is default contact from Data Import'
