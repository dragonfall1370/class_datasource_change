...
select concat('NJFC',intJobId) as 'application-positionExternalId',
		concat('NJFC',intCandidateId) as 'application-candidateExternalId',
		--*,
		...
		iif(tintInterviewLevelId in (0,1,100,104), 'FIRST_INTERVIEW',
