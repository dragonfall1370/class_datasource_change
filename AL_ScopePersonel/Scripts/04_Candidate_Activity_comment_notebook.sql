...
drop table if exists VC_CanActivityCommentNotebook
...
, iif(@objType = 3, f.ObjectId, null) as ConObjId
...
into VC_CanActivityCommentNotebook
...
select * from VC_CanActivityCommentNotebook
