...
from calls n left join temp_candidates tc on n.parent_id = tc.id
...
where n.parent_id is not null and tc.id is not null and n.parent_type in ('Accounts','Leads','Contacts')
