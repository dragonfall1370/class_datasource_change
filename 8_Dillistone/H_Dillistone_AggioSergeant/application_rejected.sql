...
map_stage AS (
	...
	ac.modified_on::timestamp rejected_date,
	CASE
...
cte_application AS (
	...
	*,
	...
	AND real_stage IN ('Longlist Withdrew', 'Longlist Reject', 'Internal Interview Withdrew', 'Internal Interview Reject', 'Shortlist Withdrew', 'Shortlist Reject', 'Client Interview Withdrew',
											'Client Interview Reject', 'Offer Withdrew', 'Offer Reject')
)
