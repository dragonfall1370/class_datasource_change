...
select
	...
	, c.company_website as 'company-website' --limitted by 100 characters
...
-- select * -- select count (*) --3825 -- select distinct cast(c.company_locationCountry as varchar(max))
from CompanyImportAutomappingTemplate c
...
select count(*) from comment --12371
