...
, left(replace(replace(replace(replace(concat('Candidate External ID: ',C.ContactID,char(10)
	...
	,iif(CCFV.URLList = '' or CCFV.URLList is NULL,'',concat('Candidate custom field: ',char(10),CCFV.URLList,char(10)))
...
where ContactID between 955467 and 1035467
where ContactID between 1035468 and 1055467
