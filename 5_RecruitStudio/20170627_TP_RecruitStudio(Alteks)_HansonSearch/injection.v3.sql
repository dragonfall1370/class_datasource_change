...
select * from position_candidate_feedback where candidate_id = 34932 and comment_body like 'From: %'
...
select top 2000
                ...
                , Coalesce(NULLIF(case
                        ...
                        when Segment.Segment = 'digital' then 'Digital'
...
and CL.ContactId in ('314208-8189-6324')
